...
const Footer = () => {
    return (
        <div className='mt-10  bg-slate-800 text-white py-20'>

            <div className='container mx-auto  grid grid-cols-2 gap-5 p-2 md:flex md:justify-between'>
                <div>
                    <h2 className='text-2xl py-2 font-semibold'>Epicurean Eats</h2>
                    <p className='text-sm   py-2'>Experience pure exhilaration at Epicurean Eats!</p>
                    <div>
                        <img src='' alt="" />
                    </div>
